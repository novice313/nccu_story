...
public class tempVoiceObject {
	...
	public tempVoiceObject() {

	}

	public void saveVoiceObject(final String mp3_file_path,final String Tagi,final int SubTagi) {
		...
		new Thread() {
			...
			public void run() {
				try {
					...
					file = new ParseFile("Atemp.mp3", data);//change
