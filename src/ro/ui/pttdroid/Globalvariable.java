...
public class Globalvariable {
   ...
   // String contentString="肉形石，是於清朝時期的一個宮廷珍玩，長5.73公分，寬6.6公分，厚5.3公分，現存於台北國立故宮博物院，肉形石的由來是一塊自然生成的瑪瑙，瑪瑙生成過程中受到雜質的影響，呈現一層一層不同顏色的層次，製作此肉形石的工匠，將質感豐富的石材表面加工鑽孔，並將表面的石皮染色，做成了這件層次分明，毛孔和肌理都逼真展現的作品。外觀看過去就像一塊肥嫩的東坡肉，因而稱「肉形石」。";
